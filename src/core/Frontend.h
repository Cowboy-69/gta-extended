...
#ifdef EX_CONTROL
	static bool m_PrefsInvertVertically;
	static float m_PrefsPadLookSensX;
	static float m_PrefsPadAimSensX;
	static float m_PrefsPadLookSensY;
	static float m_PrefsPadAimSensY;
	static int8 m_PrefsLeftStickDeadzone;
	static int8 m_PrefsRightStickDeadzone;
	static float m_PrefsVibrationForce;
	static bool m_PrefsAutoaim;
	static float m_PrefsMouseLookSensX;
	static float m_PrefsMouseAimSensX;
	static float m_PrefsMouseLookSensY;
	static float m_PrefsMouseAimSensY;
#endif
#ifdef EX_GPS
	static bool m_PrefsGPS;
#endif
#ifdef EX_FIRST_PERSON // Menu
	static int8 m_PrefsFOV_FP;
	static bool m_PrefsAutocenterCamInVeh_FP;
#endif
#ifdef EX_AUTO_SAVE // Menu
	static bool m_PrefsAutosave;
#endif
