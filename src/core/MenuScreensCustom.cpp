...
// Menu screens array is at the bottom of the file.
	...
	#define DENSITY_SLIDERS \
		MENUACTION_CFO_SLIDER, "FEM_PED", { new CCFOSlider(&CIniFile::PedNumberMultiplier, "Display", "PedDensity", 1.7f, 3.4f, PedDensityChange) }, 0, 0, MENUALIGN_LEFT, \
		MENUACTION_CFO_SLIDER, "FEM_CAR", { new CCFOSlider(&CIniFile::CarNumberMultiplier, "Display", "CarDensity", 1.7f, 3.4f, CarDensityChange) }, 0, 0, MENUALIGN_LEFT,
#else
...
CMenuScreenCustom aScreens[] = {
	...
	{ "FET_LG", MENUPAGE_NEW_GAME, nil, nil,
		...
		MENUACTION_CHECKSAVE,	"FEM_SL9", {nil, SAVESLOT_0,		0}, 40, 90, MENUALIGN_LEFT,
		MENUACTION_CHECKSAVE,	"FEM_SL1", {nil, SAVESLOT_1,		0}, 0, 0, MENUALIGN_LEFT,
#else
...
#ifdef AUTOSAVE_AND_SAVE_ANYWHERE
		MENUACTION_GOBACK,		"FEDS_TB", {nil, SAVESLOT_NONE,	0}, 320, 365, MENUALIGN_CENTER,
#else
	...
	{ "FET_OPT", MENUPAGE_NONE, nil, nil,
		 ...
		 MENUACTION_CHANGEMENU,		"FEO_OTH", {nil, SAVESLOT_NONE, MENUPAGE_OTHER_SETTINGS}, 0, 0, MENUALIGN_CENTER,
#endif
...
#ifdef AUTOSAVE_AND_SAVE_ANYWHERE
		MENUACTION_SAVE_GAME_IN_PAUSE,	"GMSAVE",	{nil, SAVESLOT_NONE, MENUPAGE_NONE}, 0, 0, MENUALIGN_CENTER,
#endif
		MENUACTION_CHANGEMENU,	"FEP_QUI",	{nil, SAVESLOT_NONE, MENUPAGE_EXIT}, 0, 0, MENUALIGN_CENTER,
   },
...
#ifdef AUTOSAVE_AND_SAVE_ANYWHERE
	// MENUPAGE_CANT_SAVE_GAME = 49
	{ "FET_SG", MENUPAGE_PAUSE_MENU, nil, nil,
		MENUACTION_LABEL,	"FES_SAV",	{nil, SAVESLOT_LABEL,	MENUPAGE_NONE}, 0, 0, 0,
		MENUACTION_GOBACK,	"FEM_OK",	{nil, SAVESLOT_NONE,	MENUPAGE_PAUSE_MENU}, 320, 225, MENUALIGN_CENTER,
	},
#endif
#if defined AUTOSAVE_AND_SAVE_ANYWHERE && defined IMPROVED_TECH_PART // Other settings
	...
	{ "FEO_OTH", MENUPAGE_OPTIONS, nil, nil,
		...
		MENUACTION_AUTOSAVE, "FET_AUT", { nil, SAVESLOT_NONE, MENUPAGE_OTHER_SETTINGS }, 0, 0, MENUALIGN_LEFT,
