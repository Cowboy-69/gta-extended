...
void RestoreDefDisplay(int8 action) {
	...
	#endif
	#ifdef FREE_CAM
#ifdef EX_CONTROL // Free camera is enabled by default
...
CMenuScreenCustom aScreens[MENUPAGES] = {
...
#ifdef EX_CONTROL // Menu
	{ "FET_AGC", MENUPAGE_CONTROLLER_PC, MENUPAGE_CONTROLLER_PC, nil, nil,
	...
	{ "FET_DIS", MENUPAGE_OPTIONS, MENUPAGE_OPTIONS, nil, nil,
		...
		DENSITY_SLIDERS
		CUTSCENE_BORDERS_TOGGLE
#ifndef EX_CONTROL // Remove free cam toggle
		FREE_CAM_TOGGLE
#endif
		MENUACTION_SUBTITLES,	"FED_SUB", { nil, SAVESLOT_NONE, MENUPAGE_DISPLAY_SETTINGS },
#ifdef EX_GPS // Menu
		MENUACTION_GPS,			"FED_GPS", { nil, SAVESLOT_NONE, MENUPAGE_DISPLAY_SETTINGS },
#endif
...
#ifdef EX_MISC // Swapping buttons while saving the game
	...
	{ "FET_CTL", MENUPAGE_OPTIONS, MENUPAGE_OPTIONS, nil, nil,
#if !defined EX_CONTROL && defined PC_PLAYER_CONTROLS
		MENUACTION_CTRLMETHOD,	"FET_CME", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_PC },
#endif
#ifdef EX_CONTROL // Menu
		MENUACTION_CHANGEMENU, "FET_RDK", { nil, SAVESLOT_NONE, MENUPAGE_KEYBOARD_CONTROLS },
#else
		MENUACTION_KEYBOARDCTRLS,"FET_RDK", { nil, SAVESLOT_NONE, MENUPAGE_KEYBOARD_CONTROLS },
#endif
#ifdef GAMEPAD_MENU
#ifdef EX_CONTROL // Menu
		MENUACTION_CHANGEMENU,	"FET_AGS", {nil, SAVESLOT_NONE, MENUPAGE_GAMEPAD_SETTINGS},
		MENUACTION_CHANGEMENU,	"FET_AGC", {nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS},
#else
		...
		MENUACTION_CHANGEMENU,	"FEC_FPC", {nil, SAVESLOT_NONE, MENUPAGE_FIRST_PERSON},
#endif
   ...
   { "FET_OPT", MENUPAGE_NONE, MENUPAGE_NONE, nil, nil,
		...
		MENUACTION_CHANGEMENU,		"FEO_OTH", {nil, SAVESLOT_NONE, MENUPAGE_OTHER_SETTINGS},
#endif
   ...
   { "FET_PAU", MENUPAGE_DISABLED, MENUPAGE_DISABLED, nil, nil,
	   ...
	   MENUACTION_PHOTO_MODE,	"FEM_PHT",	{ nil, SAVESLOT_NONE, MENUPAGE_NONE },
#endif
	   MENUACTION_CHANGEMENU,	"FET_OPT",	{ nil, SAVESLOT_NONE, MENUPAGE_OPTIONS },
	   MENUACTION_CHANGEMENU,	"FEM_QT",	{ nil, SAVESLOT_NONE, MENUPAGE_EXIT },
   },
...
#ifdef EX_CONTROL // Menu
		MENUACTION_FOOTCONTROLS, "FEC_PED", { nil, SAVESLOT_NONE, MENUPAGE_PC_FOOT_CONTROLS },
		MENUACTION_VEHICLECONTROLS, "FEC_VEH", { nil, SAVESLOT_NONE, MENUPAGE_PC_VEHICLE_CONTROLS },
#endif
...
#ifdef EX_CONTROL // Menu
		MENUACTION_MOUSELOOKSENSX, "FEC_LSX", { nil, SAVESLOT_NONE, MENUPAGE_MOUSE_CONTROLS },
		MENUACTION_MOUSELOOKSENSY, "FEC_LSY", { nil, SAVESLOT_NONE, MENUPAGE_MOUSE_CONTROLS },
		MENUACTION_MOUSEAIMSENSX, "FEC_ASX", { nil, SAVESLOT_NONE, MENUPAGE_MOUSE_CONTROLS },
		MENUACTION_MOUSEAIMSENSY, "FEC_ASY", { nil, SAVESLOT_NONE, MENUPAGE_MOUSE_CONTROLS },
		MENUACTION_INVERTVERTICALLY, "FEC_IVL", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS },
#else
...
#ifdef EX_CONTROL // Menu
	// MENUPAGE_GAMEPAD_SETTINGS = 61
	{ "FET_AGS", MENUPAGE_CONTROLLER_PC, MENUPAGE_CONTROLLER_PC, nil, nil,
		MENUACTION_PADLOOKSENSX, "FEC_LSX", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS },
		MENUACTION_PADLOOKSENSY, "FEC_LSY", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS },
		MENUACTION_PADAIMSENSX, "FEC_ASX", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS },
		MENUACTION_PADAIMSENSY, "FEC_ASY", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS },
		MENUACTION_LEFTDEADZONE, "FEC_LZN", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS },
		MENUACTION_RIGHTDEADZONE, "FEC_RZN", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS },
		MENUACTION_VIBRATIONFORCE, "FEC_VBF", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS },
		MENUACTION_INVERTVERTICALLY, "FEC_IVL", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS },
		MENUACTION_AUTOAIM, "FEC_AIM", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS },
		MENUACTION_CHANGEMENU, "FEDS_TB", { nil, SAVESLOT_NONE, MENUPAGE_NONE },
	},

	// MENUPAGE_PC_FOOT_CONTROLS = 62
	{ "FET_STI", MENUPAGE_KEYBOARD_CONTROLS, nil, nil,
		
	},

	// MENUPAGE_PC_VEHICLE_CONTROLS = 63
	{ "FET_STI", MENUPAGE_KEYBOARD_CONTROLS, nil, nil,
...
#ifdef EX_FIRST_PERSON // Menu
	// MENUPAGE_FIRST_PERSON = 64
	{ "FEC_FPC", MENUPAGE_CONTROLLER_PC, MENUPAGE_CONTROLLER_PC, nil, nil,
		MENUACTION_FOV_FP, "FEC_FOV", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS },
		MENUACTION_AUTOCENTER_IN_VEHICLE_FP, "FEC_ACV", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS },
		MENUACTION_CHANGEMENU, "FEDS_TB", { nil, SAVESLOT_NONE, MENUPAGE_NONE },
	},
#endif

#ifdef EX_FRONTEND // Other settings
	// MENUPAGE_OTHER_SETTINGS = 65
	{ "FEO_OTH", MENUPAGE_OPTIONS, MENUPAGE_OPTIONS, nil, nil,
		MENUACTION_CHANGEMENU,	"FEDS_TB", { nil, SAVESLOT_NONE, MENUPAGE_NONE },
#ifdef EX_AUTO_SAVE
		MENUACTION_AUTOSAVE,	"FET_AUT", { nil, SAVESLOT_NONE, MENUPAGE_OTHER_SETTINGS },
#endif
	},
#endif
