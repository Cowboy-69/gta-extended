...
CMenuScreenCustom aScreens[] = {
	...
	{ "FEH_DIS", MENUPAGE_OPTIONS, new CCustomScreenLayout({40, 105, 25, true}), nil,
#else
	{ "FEH_DIS", MENUPAGE_OPTIONS, new CCustomScreenLayout({40, 78, 25, true}), nil,
#endif
		MENUACTION_BRIGHTNESS,	"FED_BRI", { nil, SAVESLOT_NONE, MENUPAGE_DISPLAY_SETTINGS }, 0, 0, MENUALIGN_LEFT,
...
#ifdef IMPROVED_MENU_AND_INPUT
		MENUACTION_KEYBOARDCTRLS,"FEC_RED", {nil, SAVESLOT_NONE, MENUPAGE_KEYBOARD_CONTROLS}, 320, 120, MENUALIGN_CENTER,
#else
	...
	// MENUPAGE_GAMEPAD_SETTINGS = 46
	{ "FEC_FPC", MENUPAGE_CONTROLLER_PC, nil, nil,
		MENUACTION_FOV_FP, "FEC_LKL", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS }, 40, 155, MENUALIGN_LEFT,
		MENUACTION_AUTOCENTER_IN_VEHICLE_FP, "FEC_LRT", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS }, 0, 0, MENUALIGN_LEFT,
		MENUACTION_RELATIVE_CAM_IN_VEHICLE_DB_FP, "FEC_FPO", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS }, 0, 0, MENUALIGN_LEFT,
		MENUACTION_DOOM_MODE_FP, "FEC_FPR", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS }, 0, 0, MENUALIGN_LEFT,
		MENUACTION_GOBACK, "FEDS_TB", { nil, SAVESLOT_NONE, MENUPAGE_NONE }, 0, 0, MENUALIGN_LEFT,
	},
#endif
};
