...
// Menu screens array is at the bottom of the file.
	...
	#define DENSITY_SLIDERS \
		MENUACTION_CFO_SLIDER, "FEM_PED", { new CCFOSlider(&CIniFile::PedNumberMultiplier, "Display", "PedDensity", 1.4f, 3.4f, PedDensityChange) }, 0, 0, MENUALIGN_LEFT, \
		MENUACTION_CFO_SLIDER, "FEM_CAR", { new CCFOSlider(&CIniFile::CarNumberMultiplier, "Display", "CarDensity", 1.4f, 3.4f, CarDensityChange) }, 0, 0, MENUALIGN_LEFT,
#else
...
CMenuScreenCustom aScreens[] = {
	...
	{ "FEH_DIS", MENUPAGE_OPTIONS, new CCustomScreenLayout({40, 130, 25, true}), nil,
#else
	{ "FEH_DIS", MENUPAGE_OPTIONS, new CCustomScreenLayout({40, 78, 25, true}), nil,
#endif
		MENUACTION_BRIGHTNESS,	"FED_BRI", { nil, SAVESLOT_NONE, MENUPAGE_DISPLAY_SETTINGS }, 0, 0, MENUALIGN_LEFT,
...
#ifdef IMPROVED_MENU_AND_INPUT
	// MENUPAGE_GAMEPAD_SETTINGS = 44
	{ "FET_AGS", MENUPAGE_CONTROLLER_PC, nil, nil,
		MENUACTION_PADLOOKSENSX, "FEC_LSX", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS }, 40, 100, MENUALIGN_LEFT,
		...
		MENUACTION_DEADZONE, "FEC_ZON", { nil, SAVESLOT_NONE, MENUPAGE_CONTROLLER_SETTINGS }, 0, 0, MENUALIGN_LEFT,
