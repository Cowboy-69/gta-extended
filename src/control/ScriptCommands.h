...
enum {
	...
	COMMAND_ADD_SHORT_RANGE_SPRITE_BLIP_FOR_COORD = 1230, // 04CE
#endif
#ifdef EX_SHORT_RANGE_BLIP_OPCODES // Script
	COMMAND_ADD_SHORT_RANGE_SPRITE_BLIP_FOR_CONTACT_POINT = 1392, // 0570
#endif
#ifdef EX_PED_VARIATIONS // Script
	COMMAND_SET_CHAR_CLOTHING_VARIATION = 4000, // 0FA0
	COMMAND_GET_CHAR_CLOTHING_VARIATION,
#endif
#ifdef EX_GPS // Script: SET_BLIP_ROUTE
	COMMAND_SET_BLIP_ROUTE = 4002, // 0FA2
#endif
#ifdef EX_AUTO_SAVE // Script
	COMMAND_DO_AUTO_SAVE = 4003, // 0FA3
	COMMAND_IS_AUTO_SAVE_IN_PROGRESS,
	COMMAND_GET_IS_AUTOSAVE_OFF,
	COMMAND_REQUEST_AUTO_SAVE,
	COMMAND_IS_AUTO_SAVE_REQUESTED,
#endif
#ifdef EX_UNLOCK_MISSION_NEWS_STORY // Script
	COMMAND_UNLOCK_MISSION_NEWS_STORY = 4008, // 0FA8
#endif
#ifdef EX_SET_VEHICLE_STEERING_ANGLE // Script
	COMMAND_SET_VEHICLE_STEERING_ANGLE = 4009, // 0FA9
#endif
#ifdef EX_SHORT_RANGE_BLIP_OPCODES // Script
	COMMAND_SET_BLIP_AS_SHORT_RANGE = 4010, // 0FAA
#endif
#ifdef EX_SHORT_RANGE_BLIP_OPCODES // Script
	COMMAND_IS_BLIP_SHORT_RANGE = 4011, // 0FAB
#endif
