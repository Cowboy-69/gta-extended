...
#ifdef EX_FIRST_PERSON // Near clip plane of sprites reduced during first person
...
#ifdef EX_PARTICLE // Sprites disappear when they are too close to the camera
	if (z < 0.5f) {
		if (z < 0.1f)
			return;
