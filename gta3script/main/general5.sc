...
////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////// General Mission 5 //////////////////////////////////// 
///////////////////////////////// Defend the General's Yacht / All Hands on Deck  //////////
////////////////////////////////////////////////////////////////////////////////////////////
...
OR NOT HAS_MODEL_LOADED	BERETTA
...
ATTACH_CHAR_TO_OBJECT colonel the_yacht -2.5 -1.996 4.179 0 360.0 WEAPONTYPE_AK47 //4.288 -5.171 4.179 0 360.0 WEAPONTYPE_RUGER

CREATE_CHAR PEDTYPE_CIVMALE	SPECIAL02 the_yacht_x the_yacht_y the_yacht_z colonel_goon1
sailor = colonel_goon1
GOSUB setup_sailors
ATTACH_CHAR_TO_OBJECT colonel_goon1 the_yacht 4.288 -11.674 4.179 0 360.0 WEAPONTYPE_AK47

CREATE_CHAR PEDTYPE_CIVMALE	SPECIAL02 the_yacht_x the_yacht_y the_yacht_z colonel_goon2
sailor = colonel_goon2
GOSUB setup_sailors
ATTACH_CHAR_TO_OBJECT colonel_goon2 the_yacht -4.215 -8.161 4.179 0 360.0 WEAPONTYPE_AK47

CREATE_CHAR PEDTYPE_CIVMALE	SPECIAL02 the_yacht_x the_yacht_y the_yacht_z colonel_goon3
sailor = colonel_goon3
GOSUB setup_sailors
ATTACH_CHAR_TO_OBJECT colonel_goon3 the_yacht 4.267 -4.745 4.179 0 360.0 WEAPONTYPE_AK47

CREATE_CHAR PEDTYPE_CIVMALE	SPECIAL02 the_yacht_x the_yacht_y the_yacht_z colonel_goon4
sailor = colonel_goon4
GOSUB setup_sailors
ATTACH_CHAR_TO_OBJECT colonel_goon4 the_yacht -4.225 -12.46 4.179 0 360.0 WEAPONTYPE_AK47
...
IF created_bridge_scene = 0
	...
	IF ammo < 1
		GIVE_WEAPON_TO_PLAYER player1 WEAPONTYPE_AK47 180
	ENDIF
ENDIF
...
IF stop_for_barricade = 1
	...
	ELSE
		...
		CREATE_PICKUP_WITH_AMMO AK47 PICKUP_ON_STREET 120 190.5261 885.2347 13.7132 ruger_on_yacht
	ENDIF
ENDIF
...
GIVE_WEAPON_TO_CHAR	boat_shooter_ped WEAPONTYPE_BERETTA 9999
...
GIVE_WEAPON_TO_CHAR	heli_passenger WEAPONTYPE_BERETTA 9999
...
UNLOCK_MISSION_NEWS_STORY NEWSPAPER_GENERAL5
REQUEST_AUTO_SAVE
RETURN
...
MARK_MODEL_AS_NO_LONGER_NEEDED BERETTA
