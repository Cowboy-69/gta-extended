...
VAR_INT taxi_countdown taxi_score WMOCAistance_int WMOCAistance_int_old
...
VAR_FLOAT WMOCAestx1 WMOCAesty1 WMOCAestz1
VAR_FLOAT taxi_blipx taxi_blipy taxi_blipz 
VAR_FLOAT taxi_ped_x taxi_ped_y taxi_ped_z
VAR_FLOAT x_diff y_diff x_diff_sq y_diff_sq WMOCAistance_sq WMOCAistance 
...
SQRT WMOCAistance_sq WMOCAistance
WMOCAistance_int =# WMOCAistance
WMOCAistance_int_old = WMOCAistance_int 


IF IS_PLAYER_IN_ZONE player1 DTOWN     //Unifying the time multipliers as our increased traffic/peds changes the "difficulty" dynamic for each region
OR IS_PLAYER_IN_ZONE player1 A_PORT    //Using higher mods to help account for high traffic, wanted stars, pay n spray trips, etc
OR IS_PLAYER_IN_ZONE player1 JUNKY 
OR IS_PLAYER_IN_ZONE player1 DOCKS  
OR IS_PLAYER_IN_ZONE player1 HAVANA 
OR IS_PLAYER_IN_ZONE player1 HAITI
...
WHILE NOT LOCATE_STOPPED_PLAYER_IN_CAR_3D player1 WMOCAestx1 WMOCAesty1 WMOCAestz1 4.0 4.0 4.0 TRUE  
