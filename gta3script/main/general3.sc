...
// *****************************************************************************************
// ************************************ General Mission 3 ********************************** 
// ************************************ Protect the Deal / Guardian Angels *****************
// *****************************************************************************************
		 	...
		 	IF NOT IS_CHAR_DEAD cubandrugdealerboss
		 		IF NOT IS_CHAR_DEAD cubandrugdealer1 
	  	 			IF NOT IS_CAR_DEAD otherdeal_car 
	  	 				IF LOCATE_CAR_2D otherdeal_car 465.2766 -496.3094 1.5 1.5 FALSE
						...
						ELSE	//safety timer
							IF TIMERA > 20000	//safety timer
								SET_CAR_COORDINATES otherdeal_car 465.2766 -496.3094 -100.0	//safety timer
...
UNLOCK_MISSION_NEWS_STORY NEWSPAPER_GENERAL3
REQUEST_AUTO_SAVE
RETURN
