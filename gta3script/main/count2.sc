...
PRINT_NOW CNT2_B1 10000 1  //Alright, the courier's moving the plate from the docks today.
...
PRINT_NOW CNT2_B2 10000 1  //I'm gonna go intercept them, grab the plates, lose any heat, and make my way back here.
...
PRINT_NOW CNT2_B3 10000 1  //Now. Depending how well this goes,

WHILE cs_time < 9975
	WAIT 0
	GET_CUTSCENE_TIME cs_time
ENDWHILE
PRINT_NOW CNT2_B4 10000 1  //we may have five minutes to print the money before the counterfeit syndicate finds us, or we may have all year.
...
PRINT_NOW CNT2_B5 10000 1  //Either way, I want green rolling off the presses five minutes after I get back. Got it?
...
PRINT_NOW CNT2_B6 10000 1  //Don't you worry Tommy. We'll be ready Tommy.
...
PRINT_NOW CNT2_B7 10000 1  //Me an'der boys will be around the neighbourhood case you need any heat taking care of.
...
PRINT_NOW CNT2_B8 10000 1  //Alright everybody cool?  Ok. Catch you later...                                                                                                   
...
OR NOT HAS_MODEL_LOADED	STEYR
OR NOT HAS_MODEL_LOADED	SHOTGUN2
...
GIVE_WEAPON_TO_CHAR	courier_car2_guard1 WEAPONTYPE_UZIOLD 9999
...
GIVE_WEAPON_TO_CHAR	courier_car3_guard1 WEAPONTYPE_SHOTGUN2 2
...
GIVE_WEAPON_TO_CHAR	courier_car3_guard2 WEAPONTYPE_STEYR 9999
...
GIVE_WEAPON_TO_CHAR	courier_car3_guard3 WEAPONTYPE_STEYR 9999
...
UNLOCK_MISSION_NEWS_STORY NEWSPAPER_COUNT2
SET_FADING_COLOUR 0 0 1
DO_FADE 500 FADE_IN
WAIT 0
REQUEST_AUTO_SAVE
...
MARK_MODEL_AS_NO_LONGER_NEEDED STEYR
MARK_MODEL_AS_NO_LONGER_NEEDED SHOTGUN2
