...
// *****************************************************************************************
// ********************************* Finale mission 2  ************************************* 
// ************************************ Mob Attack / Keep your Friends close ***************
// *****************************************************************************************
...
WHILE cs_time < 86980  ///86980//87568
	WAIT 0
	GET_CUTSCENE_TIME cs_time
ENDWHILE
SET_FADING_COLOUR 0 0 1
...
CREATE_PICKUP_WITH_AMMO DEAGLE PICKUP_ON_STREET 120 -401.7512 -566.0168 19.5804 python_pickup
CREATE_PICKUP_WITH_AMMO DEAGLE PICKUP_ONCE 120 -374.4366 -587.5957 25.3355 python_pickup2
...
OR boss_guard7_flag = -1
	IF boss_guard8_flag = 0
		...
		GIVE_WEAPON_TO_CHAR	boss_guard8 WEAPONTYPE_UZIOLD 9999
...
OR boss_guard9_flag = -1
	IF boss_guard10_flag = 0
		IF NOT IS_POINT_OBSCURED_BY_A_MISSION_ENTITY -358.5610 -560.1335 26.5396 1.0 1.0 2.0
			...
			GIVE_WEAPON_TO_CHAR	boss_guard10 WEAPONTYPE_UZIOLD 9999
...
AND vance_flag = -11
	IF game_timer >	sonni_timer
		IF LOCATE_PLAYER_ANY_MEANS_3D player1 -378.671 -588.595 28.17 8.5 13.0 4.0 0
			...
			GIVE_WEAPON_TO_CHAR	boss_guard1 WEAPONTYPE_UZIOLD 9999
...
OR boss_guard2_flag = -1
	IF boss_guard3_flag = 0
		...
		GIVE_WEAPON_TO_CHAR	boss_guard3 WEAPONTYPE_UZIOLD 9999
...
OR boss_guard4_flag = -1
	IF boss_guard5_flag = 0
		...
		GIVE_WEAPON_TO_CHAR	boss_guard5 WEAPONTYPE_UZIOLD 9999
...
OR boss_guard4_flag = -1
	IF boss_guard7_flag = 0
		...
		GIVE_WEAPON_TO_CHAR	boss_guard7 WEAPONTYPE_UZIOLD 9999
...
UNLOCK_MISSION_NEWS_STORY NEWSPAPER_FINALE
